...
sed -i "${line_readme}i\
| ${day_num} | [:white_check_mark:](https://adventofcode.com/2021/day/${day_num}) |  |  | [:white_check_mark:](https://github.com/totoroot/AdventOfCode2021.jl/blob/master/src/day${day_num_padded}.jl)" README.md
...
function day${day_num_padded}(input::Array = readlines(joinpath(@__DIR__, "..", "data", "day${day_num_padded}.txt")))
...
# print(Day${day_num_padded}.day${day_num_padded}())
EOL
